...
{
    uint8 staticBits = (SDCS_DR & (uint8)(~SDCS_MASK));
    SDCS_DR = staticBits | ((uint8)(value << SDCS_SHIFT) & SDCS_MASK);
}
...
{
	CyPins_SetPinDriveMode(SDCS_0, mode);
}
...
{
    return (SDCS_PS & SDCS_MASK) >> SDCS_SHIFT;
}
...
{
    return (SDCS_DR & SDCS_MASK) >> SDCS_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (SDCS_INTSTAT & SDCS_MASK) >> SDCS_SHIFT;
    }
