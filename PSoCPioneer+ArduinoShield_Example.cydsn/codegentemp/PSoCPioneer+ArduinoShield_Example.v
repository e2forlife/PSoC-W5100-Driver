// ======================================================================
// PSoCPioneer+ArduinoShield_Example.v generated from TopDesign.cysch
// 02/11/2014 at 12:10
...
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\3.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\PrISM_v2_20"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\3.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\PrISM_v2_20\PrISM_v2_20.v"
`endif
...
module top ;
    ...
    PrISM_v2_20 LED1 (
        ...
        .bitstream(Net_233),
        .tc(Net_234));
    defparam LED1.CompareType0 = 0;
    defparam LED1.CompareType1 = 0;
    defparam LED1.PulseTypeHardcoded = 0;
    defparam LED1.Resolution = 8;
    ...
    PrISM_v2_20 LED0 (
        ...
        .bitstream(Net_195),
        .tc(Net_196));
    defparam LED0.CompareType0 = 0;
    defparam LED0.CompareType1 = 0;
    defparam LED0.PulseTypeHardcoded = 0;
    defparam LED0.Resolution = 8;


    assign Net_198 = ~Net_197;


    assign Net_200 = ~Net_199;
